...
const ExploreCard = ({id,imgUrl,title,index,active,handleClick}) => (
  ...
  onClick={()=>{handleClick(id,);
    if(title === "Go To Roadmap of web"){window.open("https://roadmap.sh/full-stack", "_blank")};
    if(title === "Go To Roadmap of game"){window.open("https://roadmap.sh/game-developer","_blank")};
    if(title === "Go To Roadmap of app"){window.open("https://roadmap.sh/android","_blank")};
  }}
