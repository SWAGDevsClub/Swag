        ...
        <div>
          <div>
            ...
            <div class=" h-[0px]">
              ...
              <div  >
                <img class="relative sm:h-[500px] h-[420px] xl:w-[70%] lg:w-[70%] w-[75%] opacity-90 top-[-1150px] rounded-[50px] drop-shadow-lg m-auto shadow-[0_25px_50px_-12px_rgba(5,5,5,5.3)] blur-[3px]" src="/layer11.jpg" />
              </div>
              <motion.div 
              initial={{ opacity: 0 }}
              animate={{ opacity: 1 }}
              transition={{ ease: "easeInOut", duration: 2}}>
              <a href="/Webverse" class="absolute sm:top-[240px] top-[200px] xl:left-[25%] lg:left-[15%] md:left-[30%] sm:left-[30%] left-[10%] cursor-pointer text-center align-middle ">  
              ...
              <div className=" absolute md:text-[17px] sm:text-[15px] text-[12px] text-white lg:top-[600px] md:top-[600px] sm:top-[580px] top-[530px] left-10 right-10 cursor-pointer lg:w-[150px] p-1 md:w-[140px] sm:w-[130px] w-[100px] text-center sm:ml-[60%] ml-[25%] bg-slate-800 h-[35px] rounded-full border-2 border-orange-100 ">
          ...
          <div className="flex justify-center align-middle ">
            <div class=" h-[0px] ">
              <img class=" box relative xl:h-[550px] lg:h-[500px] sm:h-[475px] h-[450px] xl:w-[95%] lg:w-[90%] w-[80%] opacity-100 top-[-600px] rounded-[100px] drop-shadow-lg m-auto blur-[3px] " src="/layer22.jpg" />
              <motion.div 
              initial={{ opacity: 0 }}
              animate={{ opacity: 1 }}
              transition={{ ease: "easeInOut", duration: 2}}>
              <a href="/Hackfusion" class="absolute xl:top-[480px] lg:top-[490px] md:top-[620px] top-[600px] xl:left-[25%] lg:left-[18%] md:left-[25%] sm:left-[40%] left-[10%]  cursor-pointer text-center align-middle">   
              ...
              <div className=" flex justify-center align-middle absolute md:text-[17px] sm:text-[15px] text-[12px] text-white lg:top-[1125px] md:top-[1125px] top-[1060px] left-10 right-10 cursor-pointer lg:w-[150px] p-1 md:w-[140px] sm:w-[130px] w-[100px] text-center sm:ml-[60%] ml-[20%] bg-slate-800 h-[30px] rounded-full border-2 border-orange-100 ">
