    ...
    <section className=" overflow-scroll overflow-x-hidden" id="project-section">
      <div className="relative h-[2500px]">
        <motion.div  className="relative h-[1800px] w-[100%] top-0 opacity-1">
          ...
          <Link href="" className="absolute lg:text-9xl  sm:text-7xl text-6xl text-white top-16  md-right-60 right-16 md-left-60 sm:left-12 left-9 cursor-pointer text-center no-underline">OUR PROJECTS</Link>
        </motion.div>
        ...
        <div>
          ...
          <motion.div>
            <Link href="https://play.google.com/store/apps/details?id=com.sggs.sggs" className="absolute lg:text-7xl  text-5xl text-white xl:top-[350px] lg:top-[400px] md:top-[250px] sm:top-[290px] top-[280px]  md-right-60 right-20 md-left-60 left-20 cursor-pointer text-center font-semibold no-underline">SGGS APP</Link>
          </motion.div>
      ...
      <div className="relative ">
        <div>
          ...
          <motion.div>
            <Link href="https://play.google.com/store/apps/details?id=com.sggs.sggs" className="absolute lg:text-7xl  text-5xl text-white lg:top-[-1320px] md:top-[-1520px] sm:top-[-1320px] top-[-1420px]  md-right-60 right-20 md-left-60 left-20 cursor-pointer text-center font-semibold no-underline">DAILY BITES</Link>
